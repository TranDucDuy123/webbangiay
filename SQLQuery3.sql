USE [master]
GO
/****** Object:  Database [QuanLyBanHang]    Script Date: 12/1/2024 11:07:05 AM ******/
...
USE [QuanLyBanHang]
GO
/****** Object:  Table [dbo].[BinhLuan]    Script Date: 12/1/2024 11:07:05 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[ChiTietDonDatHang]    Script Date: 12/1/2024 11:07:05 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ChiTietPhieuNhap]    Script Date: 12/1/2024 11:07:05 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DonDatHang]    Script Date: 12/1/2024 11:07:05 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[KhachHang]    Script Date: 12/1/2024 11:07:05 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[LoaiSanPham]    Script Date: 12/1/2024 11:07:05 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[LoaiThanhVien]    Script Date: 12/1/2024 11:07:05 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[LoaiThanhVien_Quyen]    Script Date: 12/1/2024 11:07:05 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NhaCungCap]    Script Date: 12/1/2024 11:07:05 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[NhaSanXuat]    Script Date: 12/1/2024 11:07:05 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PhieuNhap]    Script Date: 12/1/2024 11:07:05 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Quyen]    Script Date: 12/1/2024 11:07:05 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[SanPham]    Script Date: 12/1/2024 11:07:05 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ThanhVien]    Script Date: 12/1/2024 11:07:05 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
- Khách hàng sẽ nhận được sản phẩm sau 1 - 3 ngày kể từ khi đặt hàng.', N'Giày adidas Advancourt Base được thừa hưởng lối thiết kế của đàn anh Giày adidas VS Advantage CL song vẫn có thêm nhiều điểm mới cải thiện. Với thiết kế đơn giản nhưng lại vô cùng thanh lịch.

Phần Upper của giày được các nhà thiết kế của Adidas sử dụng bằng da bạn tăng thêm độ lịch lãm khi mang. Với các đường kim mũi chỉ hoàn hảo đến từng chi tiết giúp bạn tự tin sải bước. Đây quả thật là một lựa chọn mà các phải mạnh không nên bỏ lỡ. ', N'sp2.jpg', 9, 12, 0, 0, 3, 1, 1, 2, 1, 0, N'sp2-1.jpg', N'sp2-2.jpg', N'sp2-3.jpg', N'sp2-4.jpg')
GO
...
<p>Adidas Galaxy 7 l&agrave; sự kết hợp ho&agrave;n hảo giữa c&ocirc;ng nghệ ti&ecirc;n tiến v&agrave; thiết kế thời trang, mang đến cho bạn sự hỗ trợ v&agrave; thoải m&aacute;i tối đa tr&ecirc;n từng bước chạy.</p>', N'sp3.jpg', 3, 2, 1, 2, 2, 8, 6, 1, 3, 0, N'sp3.jpg', N'sp3-2.jpg', N'sp3-2.jpg', N'sp3-2.jpg')
GO
